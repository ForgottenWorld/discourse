...
Discourse::Application.routes.draw do
  scope path: nil, constraints: { format: /(json|html|\*\/\*)/ } do
    ...
    get "c/:pparent_parent_category_slug/:parent_category_slug/:category_slug/find_by_slug" => "categories#find_by_slug"
    get "c/:ppparent_category_slug/:pparent_category_slug/:parent_category_slug/:category_slug/find_by_slug" => "categories#find_by_slug"
    get "c/:pppparent_category_slug/:ppparent_category_slug/:pparent_category_slug/:parent_category_slug/:category_slug/find_by_slug" => "categories#find_by_slug"
    ...
    get "c/:pparent_category_slug/:parent_category_slug/:category_slug/edit" => "categories#find_by_slug", constraints: { format: 'html' }
    get "c/:ppparent_category_slug/:pparent_category_slug/:parent_category_slug/:category_slug/edit" => "categories#find_by_slug", constraints: { format: 'html' }
    get "c/:pppparent_category_slug/:ppparent_category_slug/:pparent_category_slug/:parent_category_slug/:category_slug/edit" => "categories#find_by_slug", constraints: { format: 'html' }
